...
export const SALESFORCE_SCHEMA: Record<string, SFObject> = {
  Opportunity: {
    name: "Opportunity",
    label: "Opportunity (Oportunidad)",
    description:
      "Solar installation projects for Future Energy clients. Each opportunity represents a potential or active solar panel installation project.",
    relationships: [
    ...
    fields: [
      ...
      // Custom fields - Address (compound)
      {
        ...
        custom: true,
        description:
          "Compound address field with sub-fields: street, city, state, stateCode, postalCode, country, countryCode, latitude, longitude",
      },
      {
      ...
      // Custom fields - Procedures
      {
        ...
        description:
          "CFE procedures required for the installation. Multi-select, values separated by semicolons in API.",
      },
  ...
  Account: {
    ...
    description:
      "Client accounts (can be Person Accounts or Business Accounts). Linked to Opportunities.",
    relationships: [
  ...
  Documento__c: {
    ...
    description:
      "Custom object for tracking required documents per opportunity. Each record represents a document type (e.g., drone photos, meter photo). Files are attached as ContentDocumentLinks.",
    relationships: [
  ...
  ContentDocument: {
    ...
    description:
      "Standard Salesforce file storage. Files are linked to records via ContentDocumentLink.",
    relationships: [
  ...
  ContentDocumentLink: {
    ...
    description:
      "Junction object linking ContentDocument (files) to any Salesforce record.",
    fields: [
